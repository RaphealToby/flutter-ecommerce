...
class ProductDetails extends StatefulWidget {
  ...
  ProductDetails({this.product_details_name,
        ...
        children: <Widget>[
          ...
          new Row(
            children: <Widget>[
              ...
              Padding(padding: const EdgeInsets.all(5.0), child: new Text("Brand X"),)
            ],
          ),
          new Row(
            children: <Widget>[
              ...
              Padding(padding: const EdgeInsets.all(5.0), child: new Text("NEW"),)
            ],
          ),
